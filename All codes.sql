...
BEGIN
    IF APEX_APPLICATION.G_F01.count > 0 THEN
        FOR I IN 1..APEX_APPLICATION.G_F01.count LOOP
            UPDATE PRODUCT_PRICE_APPROVAL_DTL
            SET IS_APPROVE = 1
            WHERE PPA_DTL_ID = APEX_APPLICATION.G_F01(I);
            COMMIT;
        END LOOP;
    END IF;
END;
...
-- PROVIDE THIS IN THE CSS CLASS OPTION FOR CUSTOM HEIGHT AND WEIGHT
js-dialog-size1400x580
